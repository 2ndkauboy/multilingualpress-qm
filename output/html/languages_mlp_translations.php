...
class QM_Output_Html_MLP_Translations extends QM_Output_Html {
	...
	protected function output_translation_table( array $translations ): void {
		echo '<thead>';
		echo '<tr>';
		printf( '<th>%s</th>', esc_html__( 'Locale', 'multilingualpress' ) );
		printf( '<th>%s</th>', esc_html__( 'Title', 'multilingualpress' ) );
		printf( '<th>%s</th>', esc_html__( 'Post ID', 'multilingualpress' ) );
		printf( '<th>%s</th>', esc_html__( 'Site ID', 'multilingualpress' ) );
		echo '</tr>';
		echo '<tbody>';
	...
	public function panel_menu( array $menu ) {
		...
		$menu['qm-languages']['children'][] = $this->menu(
			[
				'title' => sprintf(
					esc_html__( 'Content Translations (%s)', 'multilingualpress' ),
